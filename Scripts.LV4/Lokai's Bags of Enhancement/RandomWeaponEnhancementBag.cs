...
{
	public class RandomWeaponEnhancementBag : CustomBag
	{
		private Mobile m_BagBoundToPlayer;
		private ArrayList m_Serials;
		private string EnhanceName = "Enhanced by Lokai's Magical Bag of Weapon Enhancement.";
		private string TagName = "HasWeaponEnhancementBag";

		[Constructable]
		public RandomWeaponEnhancementBag() : base()
		{
			Name = "Lokai's Magical Bag of Weapon Enhancement";
			Weight = 2.0;
			m_Serials = new ArrayList();
		}

		public RandomWeaponEnhancementBag( Serial serial ) : base( serial )
		{
		}
		...
		public override bool OnDragDropInto( Mobile m, Item item, Point3D p )
		{
			...
			{
				EnhanceWeapon( item, EnhanceName );
			...
			{
				from.SendMessage("That item is not a weapon!");
				return false;
			}
		}
