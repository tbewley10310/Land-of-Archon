...
{
	public class RandomArmorEnhancementBag : CustomBag
	{
		private Mobile m_BagBoundToPlayer;
		private ArrayList m_Serials;
		private string EnhanceName = "Enhanced by Lokai's Magical Bag of Armor Enhancement.";
		private string TagName = "HasArmorEnhancementBag";

		[Constructable]
		public RandomArmorEnhancementBag() : base()
		{
			Name = "Lokai's Magical Bag of Armor Enhancement";
			Weight = 2.0;
			m_Serials = new ArrayList();
		}

		public RandomArmorEnhancementBag( Serial serial ) : base( serial )
		{
		}
		...
		public override bool OnDragDropInto( Mobile m, Item item, Point3D p )
		{
			...
			{
				from.SendMessage("That item is not armor!");
				return false;
			}
		}
