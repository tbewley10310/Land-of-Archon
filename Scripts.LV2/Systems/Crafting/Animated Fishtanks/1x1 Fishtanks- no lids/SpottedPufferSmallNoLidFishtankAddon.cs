...
{
	public class SpottedPufferSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SpottedPufferSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public SpottedPufferSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "a Spotted Puffer";
			AddComponent( ac, 1, 1, 16 );

		}

		public SpottedPufferSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class SpottedPufferSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SpottedPufferSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public SpottedPufferSmallNoLidFishtankAddonDeed()
		{
			Name = "an Spotted Puffer small fishtank";
		}

		public SpottedPufferSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
