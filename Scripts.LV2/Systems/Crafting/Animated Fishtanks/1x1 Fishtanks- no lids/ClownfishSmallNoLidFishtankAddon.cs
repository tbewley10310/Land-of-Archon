...
{
	public class ClownfishSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new ClownfishSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public ClownfishSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15105 );
			ac.Name = "a Clownfish";
			AddComponent( ac, 1, 1, 16 );

		}

		public ClownfishSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class ClownfishSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new ClownfishSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public ClownfishSmallNoLidFishtankAddonDeed()
		{
			Name = "a Clownfish small fishtank";
		}

		public ClownfishSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
