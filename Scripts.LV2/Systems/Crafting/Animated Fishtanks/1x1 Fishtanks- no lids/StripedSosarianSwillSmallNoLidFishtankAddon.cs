...
{
	public class StripedSosarianSwillSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new StripedSosarianSwillSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public StripedSosarianSwillSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15114 );
			ac.Name = "a Striped Sosarian Swill";
			AddComponent( ac, 1, 1, 16 );

		}

		public StripedSosarianSwillSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class StripedSosarianSwillSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new StripedSosarianSwillSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public StripedSosarianSwillSmallNoLidFishtankAddonDeed()
		{
			Name = "a Striped Sosarian Swill small fishtank";
		}

		public StripedSosarianSwillSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
