...
{
	public class AngelfishSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new AngelfishSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public AngelfishSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "an Angelfish";
			AddComponent( ac, 1, 1, 17 );

		}

		public AngelfishSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class AngelfishSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new AngelfishSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public AngelfishSmallNoLidFishtankAddonDeed()
		{
			Name = "an Angelfish small fishtank";
		}

		public AngelfishSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
