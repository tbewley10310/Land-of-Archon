...
{
	public class MinocBlueSmallNoLidFishtankAddon: BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new MinocBlueSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public MinocBlueSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15102 );
			ac.Name = "a Minoc Blue";
			AddComponent( ac, 1, 1, 16 );

		}

		public MinocBlueSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class MinocBlueSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new MinocBlueSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public MinocBlueSmallNoLidFishtankAddonDeed()
		{
			Name = "a MinocBlue small fishtank";
		}

		public MinocBlueSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
