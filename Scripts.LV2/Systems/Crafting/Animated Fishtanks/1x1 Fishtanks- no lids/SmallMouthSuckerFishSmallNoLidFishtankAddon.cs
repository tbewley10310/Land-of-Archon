...
{
	public class SmallMouthSuckerFishSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SmallMouthSuckerFishSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public SmallMouthSuckerFishSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15104 );
			ac.Name = "a Smallmouth Suckerfish";
			AddComponent( ac, 1, 1, 16 );

		}

		public SmallMouthSuckerFishSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class SmallMouthSuckerFishSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SmallMouthSuckerFishSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public SmallMouthSuckerFishSmallNoLidFishtankAddonDeed()
		{
			Name = "a Small Mouth Suckerfish small fishtank";
		}

		public SmallMouthSuckerFishSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
