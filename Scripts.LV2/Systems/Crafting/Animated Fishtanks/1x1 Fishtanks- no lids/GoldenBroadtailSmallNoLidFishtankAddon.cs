...
{
	public class GoldenBroadtailSmallNoLidFishtankAddon: BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new GoldenBroadtailSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public GoldenBroadtailSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "a Golden Broadtail";
			AddComponent( ac, 1, 1, 16 );

		}

		public GoldenBroadtailSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class GoldenBroadtailSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new GoldenBroadtailSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public GoldenBroadtailSmallNoLidFishtankAddonDeed()
		{
			Name = "a Golden Broadtail small fishtank";
		}

		public GoldenBroadtailSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
