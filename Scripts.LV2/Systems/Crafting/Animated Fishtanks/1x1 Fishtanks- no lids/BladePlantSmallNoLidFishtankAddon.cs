...
{
	public class BladePlantSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new BladePlantSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public BladePlantSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "a blade plant";
			AddComponent( ac, 1, 1, 16 );
		}

		public BladePlantSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BladePlantSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new BladePlantSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public BladePlantSmallNoLidFishtankAddonDeed()
		{
			Name = "a blade plant small fishtank";
		}

		public BladePlantSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
