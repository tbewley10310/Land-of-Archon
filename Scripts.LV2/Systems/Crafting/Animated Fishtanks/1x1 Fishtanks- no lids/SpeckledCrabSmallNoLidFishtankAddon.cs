...
{
	public class SpeckledCrabSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SpeckledCrabSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public SpeckledCrabSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15100 );
			ac.Name = "a Speckled Crab";
			AddComponent( ac, 1, 1, 14 );

		}

		public SpeckledCrabSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class SpeckledCrabSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SpeckledCrabSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public SpeckledCrabSmallNoLidFishtankAddonDeed()
		{
			Name = "a Speckled Crab small fishtank";
		}

		public SpeckledCrabSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
