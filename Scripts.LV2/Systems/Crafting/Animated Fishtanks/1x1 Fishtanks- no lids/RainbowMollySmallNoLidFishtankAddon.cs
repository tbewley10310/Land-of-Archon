...
{
	public class RainbowMollySmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new RainbowMollySmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public RainbowMollySmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "a Rainbow Molly";
			AddComponent( ac, 1, 1, 16 );

		}

		public RainbowMollySmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class RainbowMollySmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new RainbowMollySmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public RainbowMollySmallNoLidFishtankAddonDeed()
		{
			Name = "a Rainbow Molly small fishtank";
		}

		public RainbowMollySmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
