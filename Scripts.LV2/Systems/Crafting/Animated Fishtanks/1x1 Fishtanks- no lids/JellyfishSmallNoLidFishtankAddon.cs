...
{
	public class JellyfishSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new JellyfishSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public JellyfishSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15118 );
			ac.Name = "a Jellyfish";
			AddComponent( ac, 1, 1, 13 );

		}

		public JellyfishSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class JellyfishSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new JellyfishSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public JellyfishSmallNoLidFishtankAddonDeed()
		{
			Name = "a Jellyfish small fishtank";
		}

		public JellyfishSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
