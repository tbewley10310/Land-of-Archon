...
{
	public class FandancerSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new FandancerSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public FandancerSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15101 );
			ac.Name = "Fandancer";
			AddComponent( ac, 1, 1, 16 );
		}

		public FandancerSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class FandancerSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new FandancerSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public FandancerSmallNoLidFishtankAddonDeed()
		{
			Name = "a Fandancer small fishtank";
		}

		public FandancerSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
