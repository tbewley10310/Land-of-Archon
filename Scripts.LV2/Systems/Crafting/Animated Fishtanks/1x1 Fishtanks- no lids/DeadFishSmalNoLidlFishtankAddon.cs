...
{
	public class DeadFishSmalNoLidlFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new DeadFishSmalNoLidlFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public DeadFishSmalNoLidlFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15116 );
			ac.Name = "a Dead Fish";
			AddComponent( ac, 1, 1, 16 );

		}

		public DeadFishSmalNoLidlFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class DeadFishSmalNoLidlFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new DeadFishSmalNoLidlFishtankAddon();
			}
		}

		[Constructable]
		public DeadFishSmalNoLidlFishtankAddonDeed()
		{
			Name = "a Dead Fish small fishtank";
		}

		public DeadFishSmalNoLidlFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
