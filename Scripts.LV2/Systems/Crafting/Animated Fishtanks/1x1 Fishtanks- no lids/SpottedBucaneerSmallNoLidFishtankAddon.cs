...
{
	public class SpottedBucaneerSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new SpottedBucaneerSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public SpottedBucaneerSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			ac.Name = "a Spotted Bucaneer";
			AddComponent( ac, 1, 1, 16 );

		}

		public SpottedBucaneerSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class SpottedBucaneerSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new SpottedBucaneerSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public SpottedBucaneerSmallNoLidFishtankAddonDeed()
		{
			Name = "a Spotted Bucaneer small fishtank";
		}

		public SpottedBucaneerSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
