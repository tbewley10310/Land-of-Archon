...
{
	public class AlbinoAngelfishSmallNoLidFishtankAddon: BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new AlbinoAngelfishSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public AlbinoAngelfishSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15108 );
			ac.Name = "Albino Angelfish";
			AddComponent( ac, 1, 1, 16 );

		}

		public AlbinoAngelfishSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class AlbinoAngelfishSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new AlbinoAngelfishSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public AlbinoAngelfishSmallNoLidFishtankAddonDeed()
		{
			Name = "an Albino Angelfish small fishtank";
		}

		public AlbinoAngelfishSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
