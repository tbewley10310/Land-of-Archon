...
{
	public class BritainiaCrownFishSmallNotLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new BritainiaCrownFishSmallNotLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public BritainiaCrownFishSmallNotLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15103 );
			ac.Name = "a britainia crownfish";
			AddComponent( ac, 1, 1, 16 );

		}

		public BritainiaCrownFishSmallNotLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BritainiaCrownFishSmallNotLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new BritainiaCrownFishSmallNotLidFishtankAddon();
			}
		}

		[Constructable]
		public BritainiaCrownFishSmallNotLidFishtankAddonDeed()
		{
			Name = "a Britainia Crown Fish small fishtank";
		}

		public BritainiaCrownFishSmallNotLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
