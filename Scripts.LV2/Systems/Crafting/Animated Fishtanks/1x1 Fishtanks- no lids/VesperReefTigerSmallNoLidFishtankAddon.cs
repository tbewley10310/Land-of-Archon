...
{
	public class VesperReefTigerSmallNoLidFishtankAddon : BaseAddon
	{
		public override BaseAddonDeed Deed
		{
			get
			{
				return new VesperReefTigerSmallNoLidFishtankAddonDeed();
			}
		}

		[ Constructable ]
		public VesperReefTigerSmallNoLidFishtankAddon()
		{
...
//Tank
			...
			//Plant and fish
			ac = new AddonComponent( 15112 );
			ac.Name = "a Vesper Reef Tiger";
			AddComponent( ac, 1, 1, 16 );

		}

		public VesperReefTigerSmallNoLidFishtankAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class VesperReefTigerSmallNoLidFishtankAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new VesperReefTigerSmallNoLidFishtankAddon();
			}
		}

		[Constructable]
		public VesperReefTigerSmallNoLidFishtankAddonDeed()
		{
			Name = "a Vesper Reef Tiger small fishtank";
		}

		public VesperReefTigerSmallNoLidFishtankAddonDeed( Serial serial ) : base( serial )
		{
		}
