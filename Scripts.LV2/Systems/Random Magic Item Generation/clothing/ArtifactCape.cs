...
{
    public class ArtifactCape : FurCape, ITokunoDyable
	{
        ...
        private static string[] m_Names = new string[]
		{
			...
			"Cape from the Order armory",
	    	"Cape from the Chaos armory",
            "Cape crafted during the The Second Age",
            "Cape crafted during the Renaissance ",
            "Cape crafted during the Third Dawn",
	    	"Cape crafted during the Age of Shadows",

              // names based on past npc's
            "Cape crafted by Lord British",
            "Cape crafted by Lord Blackthorn",
            "Cape crafted by Lady Dawn",// She was a great warrior and great follower of Virtue, and her career eventually led to her being crowned Queen,
            "Cape crafted by Sir Dupre",//Dupre is usually portrayed in official fiction as leading the True Britannians Faction in Felucca,
            "Cape crafted by Minax",//Minax is an important NPC villain in the history of Ultima. Also called the Dark Mistress, Minax first appeared in the single player game, Ultima II: Revenge of the Enchantress,
            "Cape crafted by Mondain",//Mondain was an evil sorcerer who heralded the First Age of Darkness in Sosaria. 
            "Cape crafted by The Avatar", // Avatar from the single player games
            "Cape crafted by Exodus",//Exodus was the prodigy of Mondain and Minax,
            "Cape crafted by King Casca", // Yew prosecutor turned King before killed by dawn on easports


              // names based on monsters
           "Cape crafted by a Goblin",
           "Cape crafted by a Meer",
           "Cape crafted by a Troll",
           "Cape crafted by a Ogre",
           "Cape crafted by a Daemon",
           "Cape crafted by a Orc",
           "Cape crafted by a Juka",
           "Cape crafted by a Liche",
           "Cape crafted by a Lizardman",
           "Cape crafted by a Ophidian",
           "Cape crafted by a Ratman",
           "Cape crafted by a Terathan",
                        ...
                        //"add ur extra names here",
                        //"add ur extra names here",
           "Cape from the Ancient Samurai Empire"
