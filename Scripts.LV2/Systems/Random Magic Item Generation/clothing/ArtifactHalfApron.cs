...
{
    public class ArtifactHalfApron : Obi, ITokunoDyable
	{
        ...
        private static string[] m_Names = new string[]
		{
			...
			"Half Apron from the Order armory",
	    	"Half Apron from the Chaos armory",
            "Half Apron crafted during the The Second Age",
            "Half Apron crafted during the Renaissance ",
            "Half Apron crafted during the Third Dawn",
	    	"Half Apron crafted during the Age of Shadows",

              // names based on past npc's
            "Half Apron crafted by Lord British",
            "Half Apron crafted by Lord Blackthorn",
            "Half Apron crafted by Lady Dawn",// She was a great warrior and great follower of Virtue, and her career eventually led to her being crowned Queen,
            "Half Apron crafted by Sir Dupre",//Dupre is usually portrayed in official fiction as leading the True Britannians Faction in Felucca,
            "Half Apron crafted by Minax",//Minax is an important NPC villain in the history of Ultima. Also called the Dark Mistress, Minax first appeared in the single player game, Ultima II: Revenge of the Enchantress,
            "Half Apron crafted by Mondain",//Mondain was an evil sorcerer who heralded the First Age of Darkness in Sosaria. 
            "Half Apron crafted by The Avatar", // Avatar from the single player games
            "Half Apron crafted by Exodus",//Exodus was the prodigy of Mondain and Minax,
            "Half Apron crafted by King Casca", // Yew prosecutor turned King before killed by dawn on easports


              // names based on monsters
           "Half Apron crafted by a Goblin",
           "Half Apron crafted by a Meer",
           "Half Apron crafted by a Troll",
           "Half Apron crafted by a Ogre",
           "Half Apron crafted by a Daemon",
           "Half Apron crafted by a Orc",
           "Half Apron crafted by a Juka",
           "Half Apron crafted by a Liche",
           "Half Apron crafted by a Lizardman",
           "Half Apron crafted by a Ophidian",
           "Half Apron crafted by a Ratman",
           "Half Apron crafted by a Terathan",
                        ...
                        //"add ur extra names here",
                        //"add ur extra names here",
           "Half Apron from the Ancient Samurai Empire"
