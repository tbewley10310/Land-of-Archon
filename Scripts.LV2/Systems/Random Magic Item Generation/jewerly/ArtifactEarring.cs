...
{
    public class ArtifactEarring : GoldEarrings, ITokunoDyable
	{
     ...
     /*
        ...
        */
        ...
        private static string[] m_Names = new string[]
		{
			...
			"earrings from the Order armory",
	    	"earrings from the Chaos armory",
            "earrings crafted during the The Second Age",
            "earrings crafted during the Renaissance ",
            "earrings crafted during the Third Dawn",
	    	"earrings crafted during the Age of Shadows",

              // names based on past npc's
            "earrings crafted by Lord British",
            "earrings crafted by Lord Blackthorn",
            "earrings crafted by Lady Dawn",// She was a great warrior and great follower of Virtue, and her career eventually led to her being crowned Queen,
            "earrings crafted by Sir Dupre",//Dupre is usually portrayed in official fiction as leading the True Britannians Faction in Felucca,
            "earrings crafted by Minax",//Minax is an important NPC villain in the history of Ultima. Also called the Dark Mistress, Minax first appeared in the single player game, Ultima II: Revenge of the Enchantress,
            "earrings crafted by Mondain",//Mondain was an evil sorcerer who heralded the First Age of Darkness in Sosaria. 
            "earrings crafted by The Avatar", // Avatar from the single player games
            "earrings crafted by Exodus",//Exodus was the prodigy of Mondain and Minax,
            "earrings crafted by King Casca", // Yew prosecutor turned King before killed by dawn on easports


              // names based on monsters
           "earrings crafted by a Goblin",
           "earrings crafted by a Meer",
           "earrings crafted by a Troll",
           "earrings crafted by a Ogre",
           "earrings crafted by a Daemon",
           "earrings crafted by a Orc",
           "earrings crafted by a Juka",
           "earrings crafted by a Liche",
           "earrings crafted by a Lizardman",
           "earrings crafted by a Ophidian",
           "earrings crafted by a Ratman",
           "earrings crafted by a Terathan",
                        ...
                        //"add ur extra names here",
                        //"add ur extra names here",
           "earrings from the Ancient Samurai Empire"
        ...
        public ArtifactEarring()
        {
            ...
            switch (Utility.Random(20))
            {
                ...
                case 2: Attributes.SpellDamage = Utility.RandomMinMax(10, 25); break;
