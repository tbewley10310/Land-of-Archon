...
{
    public class ArtifactRing : GoldRing, ITokunoDyable
	{
        ...
        */
        ...
        private static string[] m_Names = new string[]
		{
			...
			"Ring from the Order armory",
	    	"Ring from the Chaos armory",
            "Ring crafted during the The Second Age",
            "Ring crafted during the Renaissance ",
            "Ring crafted during the Third Dawn",
	    	"Ring crafted during the Age of Shadows",

              // names based on past npc's
            "Ring crafted by Lord British",
            "Ring crafted by Lord Blackthorn",
            "Ring crafted by Lady Dawn",// She was a great warrior and great follower of Virtue, and her career eventually led to her being crowned Queen,
            "Ring crafted by Sir Dupre",//Dupre is usually portrayed in official fiction as leading the True Britannians Faction in Felucca,
            "Ring crafted by Minax",//Minax is an important NPC villain in the history of Ultima. Also called the Dark Mistress, Minax first appeared in the single player game, Ultima II: Revenge of the Enchantress,
            "Ring crafted by Mondain",//Mondain was an evil sorcerer who heralded the First Age of Darkness in Sosaria. 
            "Ring crafted by The Avatar", // Avatar from the single player games
            "Ring crafted by Exodus",//Exodus was the prodigy of Mondain and Minax,
            "Ring crafted by King Casca", // Yew prosecutor turned King before killed by dawn on easports


              // names based on monsters
           "Ring crafted by a Goblin",
           "Ring crafted by a Meer",
           "Ring crafted by a Troll",
           "Ring crafted by a Ogre",
           "Ring crafted by a Daemon",
           "Ring crafted by a Orc",
           "Ring crafted by a Juka",
           "Ring crafted by a Liche",
           "Ring crafted by a Lizardman",
           "Ring crafted by a Ophidian",
           "Ring crafted by a Ratman",
           "Ring crafted by a Terathan",
                        ...
                        //"add ur extra names here",
                        //"add ur extra names here",
           "Ring from the Ancient Samurai Empire"
