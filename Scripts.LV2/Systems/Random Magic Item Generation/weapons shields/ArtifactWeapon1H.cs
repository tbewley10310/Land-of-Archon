...
{
    public class ArtifactWeapon1H : Katana, ITokunoDyable
	{
        ...
        private static string[] m_Names = new string[]
		{
          ...
          // names based off past npc's
            ...
            "Weapon crafted by King Casca", // Yew prosecutor turned King before killed by dawn on easports
        ...
        [Constructable]
        public ArtifactWeapon1H()
        {
            Name = m_Names[Utility.Random(m_Names.Length)];
            Hue = Utility.RandomMinMax(5, 3000);
            // Name = "Artifact 1 Handed Weapon";
            ...
            {
                case 0: ItemID = 5119; break;//katana
                case 1: ItemID = 5049; break;//vikingsword
                case 2: ItemID = 3780; break;//skinningknife
                case 3: ItemID = 3936; break;//longsword
                case 4: ItemID = 5047; break;//longsword old
                case 5: ItemID = 9934; break;//paladinsword
                case 6: ItemID = 5040; break;// waraxe 1hander
                case 7: ItemID = 3932; break;//mace
                case 8: ItemID = 5179; break;//maul
                case 9: ItemID = 5127; break;//warmace
                case 10: ItemID = 5121; break;//kryss
                case 11: ItemID = 5125; break;//warfork
                case 12: ItemID = 3922; break;//dagger
            ...
            switch (Utility.Random(10))
            {
                case 0: Attributes.WeaponDamage = Utility.RandomMinMax(35, 50); break;
 ...
 //Disadvantages
            ...
            public override void GetDamageTypes(Mobile wielder, out int phys, out int fire, out int cold, out int pois, out int nrgy, out int chaos, out int direct)
		{
	 	...
	 	public ArtifactWeapon1H(Serial serial) : base( serial )
	 	{
	 	}
