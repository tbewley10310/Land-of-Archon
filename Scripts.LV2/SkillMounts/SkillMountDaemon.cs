...
{ 
	public class SkillMountDemon : EtherealMount 
	{ 
		[Constructable] 
		public SkillMountDemon() : base( 11670, 0x3E91 ) 
		{ 
			Name = "Ethereal Skill Deamon";
			ItemID = 8403;
			MountedID = 16239;
			RegularID = 8403;
		...
		public SkillMountDemon( Serial serial ) : base( serial ) 
		{ 
		} 
