...
#region Lokai Versioning
                else if (Insensitive.Equals(a, "-lv1"))
                    m_LV1 = true;
                else if (Insensitive.Equals(a, "-lv2"))
                    m_LV2 = true;
                else if (Insensitive.Equals(a, "-lv3"))
                    m_LV3 = true;
                else if (Insensitive.Equals(a, "-lv4"))
                    m_LV4 = true;
                else if (Insensitive.Equals(a, "-lv5"))
                    m_LV5 = true;
#endregion
			}
