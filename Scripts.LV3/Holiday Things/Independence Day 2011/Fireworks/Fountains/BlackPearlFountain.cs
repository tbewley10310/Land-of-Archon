...
{ 
   ...
   public class BlackPearlFountain : Item 
   { 
      [Constructable] 
      public BlackPearlFountain() : base( 0x182D ) 
      { 
		Hue = 1265;
		Name = "a Black Pearl Fountain";
      } 

      public BlackPearlFountain( Serial serial ) : base( serial ) 
      { 
      }
