...
{ 
   ...
   public class SulfurousAshFountain : Item 
   { 
      [Constructable] 
      public SulfurousAshFountain() : base( 0x182D ) 
      { 
		Hue = 1260;
		Name = "a Sulfurous Ash Fountain";
      } 

      public SulfurousAshFountain( Serial serial ) : base( serial ) 
      { 
      }
	...
	public override void OnDoubleClick( Mobile from )
	{
		...
		private void FinishLaunch( object state )
		{
			...
			Effects.PlaySound( endLoc, map, 0x356 );
