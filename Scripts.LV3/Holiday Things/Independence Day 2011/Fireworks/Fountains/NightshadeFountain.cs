...
{ 
   ...
   public class NightshadeFountain : Item 
   { 
      [Constructable] 
      public NightshadeFountain() : base( 0x182D ) 
      { 
		Hue = 1275;
		Name = "a Nightshade Fountain";
      } 

      public NightshadeFountain( Serial serial ) : base( serial ) 
      { 
      }
