...
{ 
   ...
   public class MandrakeRootFountain : Item 
   { 
      [Constructable] 
      public MandrakeRootFountain() : base( 0x182D ) 
      { 
		Hue = 1269;
		Name = "a Mandrake Root Fountain";
      } 

      public MandrakeRootFountain( Serial serial ) : base( serial ) 
      { 
      }
