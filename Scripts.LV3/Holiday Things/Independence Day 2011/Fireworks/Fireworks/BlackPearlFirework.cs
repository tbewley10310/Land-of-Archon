...
{ 
   ...
   public class BlackPearlFirework : Item 
   { 
      [Constructable] 
      public BlackPearlFirework() : base( 0xA13 ) 
      { 
		Hue = 1265;
		Name = "a Black Pearl Firework";
      } 

      public BlackPearlFirework( Serial serial ) : base( serial ) 
      { 
      }
