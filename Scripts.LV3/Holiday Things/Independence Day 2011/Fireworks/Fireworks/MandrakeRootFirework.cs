...
{ 
   ...
   public class MandrakeRootFirework : Item 
   { 
      [Constructable] 
      public MandrakeRootFirework() : base( 0xA13 ) 
      { 
		Hue = 1269;
		Name = "a Mandrake Root Firework";
      } 

      public MandrakeRootFirework( Serial serial ) : base( serial ) 
      { 
      }
