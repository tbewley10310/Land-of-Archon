...
{ 
   ...
   public class SulfurousAshFirework : Item 
   { 
      [Constructable] 
      public SulfurousAshFirework() : base( 0xA13 ) 
      { 
		Hue = 1260;
		Name = "a Sulfurous Ash Firework";
      } 

      public SulfurousAshFirework( Serial serial ) : base( serial ) 
      { 
      }
	...
	public override void OnDoubleClick( Mobile from )
	{
		...
		private void FinishLaunch( object state )
		{
			...
			Effects.PlaySound( endLoc, map, 0x305 );
			Effects.SendLocationEffect( endLoc, map, 0x36B0, 16, 10, hue, renderMode );
		}
   } 
