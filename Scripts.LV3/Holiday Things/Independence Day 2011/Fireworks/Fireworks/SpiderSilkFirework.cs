...
{ 
   ...
   public class SpiderSilkFirework : Item 
   { 
      [Constructable] 
      public SpiderSilkFirework() : base( 0xA13 ) 
      { 
		Hue = 1170;
		Name = "a Spider Silk Firework";
      } 

      public SpiderSilkFirework( Serial serial ) : base( serial ) 
      { 
      }
