...
{
    public class HolidayBellAddon : Item, IDyable, IAddon
    {
        [Constructable]
        public HolidayBellAddon()
            : this(Utility.RandomDyedHue())
        {
        }

        [Constructable]
        public HolidayBellAddon(int hue)
            : base(0x9DBF)
        {
            this.Hue = hue;
            this.Movable = false;
        ...
        public HolidayBellAddon(Serial serial)
            : base(serial)
        {
        }
        ...
        public Item Deed
        {
            get
            {
                return new HolidayBellDeed(this.Hue);
            }
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (house != null && house.IsCoOwner(from))
            {
                ...
                {
                    from.CloseGump(typeof(HolidayBellAddonGump));
                    from.SendGump(new HolidayBellAddonGump(from, this));
                }
                else
                {
        ...
        private class HolidayBellAddonGump : Gump
        {
            private readonly Mobile m_From;
            private readonly HolidayBellAddon m_Addon;
    ...
    public class HolidayBellDeed : Item
    {
        [Constructable]
        public HolidayBellDeed()
            : this(0)
        {
        }

        [Constructable]
        public HolidayBellDeed(int hue)
            : base(0x14F0)
        {
            this.Hue = hue;
            this.Weight = 1.0;
        ...
        public HolidayBellDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        public void Placement_OnTarget(Mobile from, object targeted, object state)
        {
            ...
            if (house != null && house.IsCoOwner(from))
            {
                ...
                if (northWall && westWall)
                    from.SendGump(new HolidayBellDeedGump(from, loc, this));
                else
        ...
        private class HolidayBellDeedGump : Gump
        {
            private readonly Mobile m_From;
            private readonly Point3D m_Loc;
            private readonly HolidayBellDeed m_Deed;
            public HolidayBellDeedGump(Mobile from, Point3D loc, HolidayBellDeed deed)
                : base(150, 50)
            {
                this.m_From = from;
                this.m_Loc = loc;
