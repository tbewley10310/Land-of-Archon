...
namespace Server.Items
{
	...
	//	public override int LabelNumber{ get{ return 1045122; } } // leather blacksmith gloves of Lumberjacking
	...
	//	public override int LabelNumber{ get{ return 1045123; } } // studded leather blacksmith gloves of Lumberjacking
	...
	//	public override int LabelNumber{ get{ return 1045124; } } // ringmail blacksmith gloves of Lumberjacking
	...
	public abstract class BaseGlovesOfLumberjacking : BaseArmor
	{
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Bonus != 0 )
                list.Add("Lumberjacking bonus + {0}", m_Bonus.ToString()); // Lumberjacking bonus +~1_val~
		}
