...
//this 
        ...
        public override void InitCraftList()
        {
            ...
            if (!Core.AOS)	//Duplicate Entries to preserve ordering depending on era
            {
                index = this.AddCraft(typeof(FishingPole), 1044566, 1023519, 68.4, 93.4, typeof(Log), 1044041, 5, 1044351); //This is in the categor of Other during AoS
                this.AddSkill(index, SkillName.Tailoring, 40.0, 45.0);
                this.AddRes(index, typeof(Cloth), 1044286, 5, 1044287);
            }
            ...
            if (Core.ML)
            {
                ...
                index = this.AddCraft(typeof(SoulForgeDeed), 1044290, 1031696 , 100.0, 200.0, typeof(Log), 1044041, 150, 1044351);
